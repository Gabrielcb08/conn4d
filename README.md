...
Conn4D is built on **Clean Architecture** with strict, inward-pointing dependencies.

```
src/
├─ 01 - Domain/                ← exceptions, pool config record, enums + defaults
...
flowchart TD
    ...
    DO["01 · Domain — exceptions · pool config · enums · defaults"]
    PR --> AP
    AP --> CO
    IN --> CO
    CO --> DO
